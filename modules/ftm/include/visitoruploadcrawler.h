...
class VisitorUploadCrawler {
    ...
    vAdr& childrenAdrs(vertex_set_t vs, vAdr& ret, const unsigned int minResults = 1, const unsigned int maxResults = 1, const uint32_t resultPadData = LM32_NULL_PTR) const;
